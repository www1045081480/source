 ...
 */
@Entity
@Table(name = "ORDER_CURRENCY_TBL")
public class OrderCurrency {
	public static final String TABLE_NAME = "ORDER_CURRENCY_TBL";
	...
	@Id
	/*  */
	@Column(name = "ORDER_DELIVERY", length = 0, nullable = false)
	 ...
	 * Set the value of
	 * 
	 * @param orderDelivery the new value for $col.ViewName
	 */
	public void setOrderDelivery(Long orderDelivery) {
