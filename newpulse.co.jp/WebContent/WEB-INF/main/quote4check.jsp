...
<script type="text/javascript" src="js/quote4check.js?${initParam.version}"></script>
						...
						<div class="box">
							...
							<div id="print">
								<div
									...
									<div id="qtitle" align="center" ><font size="6">見&nbsp;&nbsp;&nbsp;積&nbsp;&nbsp;&nbsp;書</font></div><br><br>
							<table  border="0"  style="width:700px;height:300px;font-size: 1em;margin-top:10px" cellspacing="0px" >
						  			<tr>
						  				...
						  				<td ><a style="font-weight:bold">見積番号：</a><input  id="estimationCd" class="kinput" type="text"   onblur="this.style.border='0px solid'" readonly="readonly"/></td>
						  			</tr>
						  			<tr>
						  				...
						  				<td><a style="font-weight:bold">作成日付：</a><input id="sendtime" class="datef" value="" type="text" onfocus="setday('1',this,'yyyy-MM-dd','2000-01-01','2100-12-30',0);" readonly="readonly" /></td>
						  			</tr>
						  			<tr>
						  			...
						  			<tr>
						  				<td>
						  					<div style="float:left;width:300px;height:23px;font-weight:bold;font-size:20px;border:1px solid;">
												<input id="_select"  class="colorInput" onBlur="keydownMsg(event)" onkeydown="changeName(event)" style="height:23px;width:300px;font-weight:bold;font-size:20px;border:0px;"/>
									...
									<table border="0"
										...
										<tr>
											<td><a style="font-weight: bold">納入場所：</a><input
												id="deliveryAddress" class="ginput" type="text" value=""
												order='1px solid' /></td>
											<td><a style="font-weight: bold">有効期限：</a><input
										...
										<tr>
											<td><a style="font-weight: bold;">納入日付：</a><input class="ginput"
												id="deliveryLimitDays" value="" type="text" style="background-color:#CDFFFF;" /></td>
											<td><a style="font-weight: bold;">支払条件&nbsp;：</a><textarea id="paymentMethord"
