 ...
 */
@Entity
@Table(name = "C_I_F_ARRIVAL_TBL")
public class CIFArrival {
	public static final String TABLE_NAME = "C_I_F_ARRIVAL_TBL";

	/*
	 * ---------------------- Public Field Names Definition
	 * ----------------------------
	 */
	public static final String ArrvalId = "ArrvalId";
	...
	@Id
	/*  */
	@Column(name = "ARRVAL_ID", length = 0, nullable = false)
	private Long arrvalId;
	...
	/*  */
	@Column(name = "ARRIVAL_DATE", length = 8, nullable = true)
	 ...
	 * Set the value of
	 * 
	 * @param arrvalId the new value for $col.ViewName
	 */
	public void setArrvalId(Long arrvalId) {
	 ...
	 * Set the value of
	 * 
	 * @param arrivalDate the new value for $col.ViewName
	 */
