...
<script type="text/javascript" src="js/ordermake.js?${initParam.version}"></script>
...
<body onload="OrderSheet('${EstimationId}','${reqStr}')">
				...
				<td id="container" style="background: #d2e9ff;">
					...
					<div id="print">
				  		<div style="border: 0px solid green; width:700px;height:auto;margin-left:auto;margin-right:auto;">
				  			<div id="qtitle" align="center" ><font size="6"><b>ORDER</b></font></div>
					  		<table >
					  			<tr>
					  				<td>
					  				...
					  				<td>
					  					<table width="350px" height="320px" border="0px">
					  						...
					  						<tr height="25px">
					  							<td width="80px"></td>
					  							<td align="left">
					  								<font size="2">DATE：<input class="bg" id="sendtime"  type="text" onfocus="setday('1',this,'yyyy-MM-dd','2000-01-01','2100-12-30',0);">
					  								</font>
					  							</td>
					  						</tr>
					  		...
					  		<table border="0"  style="width:700px;height:50px;font-size: 1em;margin-top:10px" cellspacing="0px" >
					  			...
					  			<tr>
					  				<td><a style="font-weight:bold">DELIVERY ADDRESS：</a><input class="bg" id="delivery_address" value="" type="text" style="height:23px;width:180px;font-weight:bold;border:0px;" /></td>
					  				<td><a style="font-weight:bold">PAYMENT CONDITION：</a>
					  			...
					  			<tr>
					  				<td><a style="font-weight:bold">DELIVERY DATE：</a><input class="bg" id="delivery_date" class="ginput" type="text" onfocus="setday('2',this,'yyyy-MM-dd','2000-01-01','2100-12-30',0);"  readonly="readonly" style="height:23px;width:200px;font-weight:bold;border:0px;"/></td>
					  				<td><a style="font-weight:bold">PAYMENT METHOD：</a>
					 		...
					 		<p style="height: 0px;"></p>
					  		<table border="0px" style="width:700px;" cellspacing="0px">
					  			<tr style="height: 20px ;border:1px solid" >
					  				...
					  				<td style="width: 230px;border:1px solid;border-bottom:0px;font-weight:bold;" align="center">DISCOUNT</td>
					  				<td style="width: 15px;border-bottom:0px;border-top:0px"></td>
					  				<td style="width: 230px;border:1px solid;border-bottom:0px;font-weight:bold;" align="center">AMOUNT</td>
					  			</tr>
					  		...
					  		<p style=" height:10px; font-weight:bold;font-size:18px">NOTE</p>
	...
	<div id="floatPanel" >
	  		<div class="ctrolPanel" style="right:10px;">
				...
				<a class="contact" >
				<input type="button" id="changeLangCn" value="中国版" style="height:50px;width:80px" onclick="changeLangCN('${EstimationId}','${reqStr}')"/>
				</a>
				<a class="contact" >
