...
<script type="text/javascript" src="js/ordermakeCn.js?${initParam.version}"></script>
...
<body onload="OrderSheet('${EstimationId}','${reqStr}')">
				...
				<td id="container" style="background: #d2e9ff;">
					...
					<div id="print">
				  		<div style="border: 0px solid green; width:700px;height:auto;margin-left:auto;margin-right:auto;">
				  			<div id="qtitle" align="center" ><font size="6"><b>定&nbsp;&nbsp;&nbsp;&nbsp;单</b></font></div>
					  		<table >
					  			<tr>
					  				<td>
					  					<table width="350px" height="320px" border="0px">
					  						...
					  						<tr  height="100px">
					  							<td>
					  								<textarea  class="bg"  id="word" style="font-weight:bold;width:300px;height:100%;resize:none;BORDER-BOTTOM-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-TOP-STYLE: none">
敬启  非常感谢贵公司一直以来的支持！</textarea>
					  							</td>
					  						</tr>
					  						<tr  height="100px">
					  							<td>
						  							<textarea class="bg" id="title" style="heigth:40px;min-width:300px;max-width:300px;font-weight:bold;font-size:15;BORDER-BOTTOM-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-TOP-STYLE: none;background-color:#CDFFFF" value="">
					  								</textarea>
					  							</td>
					  						</tr>
					  					</table>
					  				...
					  				<td>
					  					<table width="350px" height="320px" border="0px">
					  						...
					  						<tr height="25px">
					  							<td width="80px"></td>
					  							<td align="left">
					  								<font size="2">发行日：<input class="bg" id="sendtime"  type="text" onfocus="setday('1',this,'yyyy-MM-dd','2000-01-01','2100-12-30',0);">
					  								</font>
					  							</td>
					  						</tr>
					  						...
					  						<tr>
					  							...
					  							<td align="left">
					  								<table cellspacing="0px">
					  									<tr width="300px">
						  									<td  width="80px" align="center" style="border: 1px solid">社&nbsp;&nbsp;&nbsp;长</td>
						  									<td  width="80px" align="center" style="border: 1px solid">副社长</td>
					  		...
					  		<table border="0"  style="width:700px;height:50px;font-size: 1em;margin-top:10px" cellspacing="0px" >
					  			...
					  			<tr>
					  				<td><a style="font-weight:bold">交货地点：</a><input class="bg" id="delivery_address" value="" type="text" style="height:23px;width:200px;font-weight:bold;border:0px;" /></td>
					  				<td><a style="font-weight:bold">支付条件：</a>
					  				<textarea class="bg" id="payment_condition"    style="min-width: 200px; max-width: 200px; overflow: hidden; word-wrap: break-word; resize: horizontal; font-weight:bold;border:0px;"></textarea>
					  			</tr>
					  			<tr>
					  			...
					  			<tr>
					  				<td><a style="font-weight:bold">交货日期 ：</a><input class="bg" id="delivery_date" class="ginput" type="text" onfocus="setday('2',this,'yyyy-MM-dd','2000-01-01','2100-12-30',0);"  readonly="readonly" style="height:23px;width:200px;font-weight:bold;border:0px;"/></td>
					  				<td><a style="font-weight:bold">支付方式：</a>
					  				<input class="bg" id="payment_method"    style="height:23px;width:200px;font-weight:bold;border:0px;"/>
					  			</tr>
					  			<tr>
					  				<td><hr style="border:1px solid "/></td>
					  				<td><hr style="border:1px solid "/></td>
					 		...
					 		<p style="height: 0px;"></p>
					  		<table border="0px" style="width:700px;" cellspacing="0px">
					  			<tr style="height: 20px ;border:1px solid" >
					  				...
					  				<td style="width: 230px;border:1px solid;border-bottom:0px;font-weight:bold;" align="center">折扣</td>
					  				<td style="width: 15px;border-bottom:0px;border-top:0px"></td>
					  				<td style="width: 230px;border:1px solid;border-bottom:0px;font-weight:bold;" align="center">不含税合计</td>
					  			</tr>
					  			<tr style="height: 45px;border:1px">
					  				...
					  				<td style="width: 15px;border-top:0px"></td>
					  				<td style="width: 230px;border:1px solid" align="right">
					  					<div id="monery1" style="border:0px solid;width:10px;height:10px;float:left">￥</div><a id="tsum">0</a>
					  				</td>
					  			</tr>
					  		</table>
	...
	<div id="floatPanel" >
	  		<div class="ctrolPanel" style="right:10px;">
				...
				<br/>
				<a class="contact" >
				<input type="button" id="changeLangEn" value="英语版" style="height:50px;width:80px" onclick="changeLangEN('${EstimationId}','${reqStr}')"/>
				</a>
				<a class="contact" >
				<input type="button" id="changeLangJp" value="日语版" style="height:50px;width:80px" onclick="changeLangJP('${EstimationId}','${reqStr}')"/>
				</a>
				<a class="contact" >
