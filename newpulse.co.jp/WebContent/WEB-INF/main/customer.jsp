...
<html>
<script type="text/javascript" src="js/customer.js?${initParam.version}"></script>
					...
					<div>
						<div id="inputPane">
							<div class="regist clearfix">
								<h3 id="h3">&nbsp;得意先登録・検索・更新</h3>
								<div id="regist_cont" class="clearfix">

									<form id="form">
										<input id="customerid" name="customerid" type="text" value=""
											style="display: none">
										<table class="regist_tbl" summary="得意先ー登録">
											<tbody>
												<tr>
													<th style="width:150px;" class="" scope="row">会社名（日本語）</th>
												...
												<tr style="display: none">
													<th class="req" scope="row">電話番号２</th>
												...
												<tr>
													<th class="req" scope="row">ファクス</th>
