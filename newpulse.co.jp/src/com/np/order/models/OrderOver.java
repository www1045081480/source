 ...
 */
@Entity
@Table(name = "ORDER_OVER_TBL")
public class OrderOver {
	public static final String TABLE_NAME = "ORDER_OVER_TBL";
	...
	@Id
	/*  */
	@Column(name = "OVER_ID", length = 0, nullable = false)
	private Long overId;
	 ...
	 * Set the value of
	 * 
	 * @param overId the new value for $col.ViewName
	 */
