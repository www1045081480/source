...
<script type="text/javascript" src="js/quote.js?${initParam.version}"></script>
...
<body onload="EstmationSheet()">
					  		...
					  		<div style="border: 0px solid green; width:700px;height:auto;margin-left:auto;margin-right:auto;">
						  		...
						  		<table  border="0"  style="width:700px;height:300px;font-size: 1em;margin-top:10px" cellspacing="0px" >
						  			...
						  			<tr>
						  				...
						  				<td ><a style="font-weight:bold">見積番号：</a><input  id="EstimationCd" class="kinput" type="text" value=""  onblur="this.style.border='0px solid'" readonly="readonly"/></td>
						  			</tr>
						  			<tr>
						  				...
						  				<td><a style="font-weight:bold">作成日付：</a><input id="sendtime" value="" type="text" onfocus="setday('1',this,'yyyy-MM-dd','2000-01-01','2100-12-30',0);" readonly="readonly" /></td>
						  			</tr>
						  			<tr>
						  			...
						  			<tr>
						  				<td>
						  					<input class="einput" type="text" value="拝啓　貴社ますますご繁栄のこととお喜び申し上げます." onmousedown="this.style.border='1px solid'" onblur="this.style.border='0px solid'"/>
						  					<input class="einput" type="text" value="どうもありがとうございました！" onmousedown="this.style.border='1px solid'" onblur="this.style.border='0px solid'"/>
						  				</td>
						  						...
						  						<table cellspacing="0px">
					  									...
					  									<tr style="border: 1px solid">
					  										<td id ="maxApprove" height="80px" style="border: 1px solid;text-align:center;">
					  											<input id="maxbt" type="button" value="承認"    onclick="maxApprove(${session.User.role},${session.User.userId})"/>
					  										</td>
					  				 						<td id ="minApprove"  height="80px" style="border: 1px solid;text-align:center;" >
					  				 							<input id="minbt" type="button" value="承認"   onclick="minApprove(${session.User.role},${session.User.userId})"/>
					  				 						</td>
						  		...
						  		<table border="0"  style="width:700px;height:50px;font-size: 1em;margin-top:10px" cellspacing="0px" >
						  			<tr>
						  				<td colspan="1"><a style="font-weight:bold;" width='50px'>納入方式：</a>
						  			...
						  			<tr>
						  				<td><a style="font-weight:bold">納入場所：</a><input id="DeliveryAddress"  class="ginput" type="text" value="" onmousedown="this.style.border='1px solid'" onblur="this.style.border='0px solid'"/></td>
						  				<td><a style="font-weight:bold">有効期限 ：</a><input  id="yxtime" class="colorInput" value="" type="text" onfocus="setday('1',this,'yyyy-MM-dd','2000-01-01','2100-12-30',0);" readonly="readonly"/></td>
						  			</tr>
						  			<tr>
						  				<td><hr style="border:1px solid "/></td>
						  				<td><hr style="border:1px solid "/></td>
						  			...
						  			<tr>
						  				<td><a style="font-weight:bold">納入日付：</a><input id="narutime"  class="ginput" value="" type="text" onmousedown="this.style.border='1px solid'" onblur="this.style.border='0px solid'"/></td>
						  				<td><a style="font-weight:bold">支払条件：</a><textarea id="PaymentCondition" style="background-color:#CDFFFF;min-width: 220px; max-width: 220px;"  class="binput"  onmousedown="this.style.border='1px solid'" onblur="this.style.border='0px solid'">到货后第二个月付款</textarea></td>
						  			</tr>
						  			<tr>
						  				<td><hr style="border:1px solid "/></td>
						  				<td><hr style="border:1px solid "/></td>
								...
								<p style=" height:10px; font-weight:bold;font-size:18px">見積一覧</p>
						 		<table border="1" id="sptable" style="width:700px;font-size: 1em;border-bottom:0px solid;border-left:0px solid;border-right:0px solid" cellspacing="0px" >
						 			<tr id="thead">
						 				...
						 				<td style="border-right:1px solid">備考</td>
	...
	<div id="floatPanel" >
	  		<div class="ctrolPanel" style="right:10px;">
				...
				<br/>
				<a class="contact" >
				<input type="button" id="change" value="中文版" style="height:50px;width:80px" onclick="pageChange()"/>
				</a>
				<a class="contact" >
