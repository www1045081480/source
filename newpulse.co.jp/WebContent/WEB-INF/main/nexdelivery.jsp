...
<body onload="nexdeliveryStar();">
	<input id="nexdeliveryyear" type="hidden" value="<s:property value='year'/>">
	<input id="nexdeliverymm" type="hidden" value="<s:property value='month'/>">
	...
	<input id="year1" type="hidden" value="<s:property value="year"/>">
	<input id="month1" type="hidden" value="<s:property value="month"/>">
...
<div id="print">
  		<div  id="div1" >
		  		<div id="flip" ><select id="year"></select>年<select id="mon"></select>月配送一覧<br/><br/>
		  			<div  id="flip1">
		  				販売先<input id="customerName" value="<s:property value="customerName"/>" type="text" style="width:200px;"    onBlur="keydownMsg1(event)" onkeydown="changeName1(event)" />
		  				販売先注文番号<input id="customerOrder" value="<s:property value="customerOrder"/>" type="text" style="width:150px"   />
		  				<input  value="検索" type="button" style="width:70px" onclick="nexdeliveryFind()"  />
		  				<input  value="クリア" type="button" style="width:70px" onclick="receiveClean1()"  />
		  			</div>
		  		</div>
		  		...
		  		<table  border="1px　solid" cellspacing="0px" style="font-size:0.6em;margin-left:auto;margin-right:auto;width: 900px;margin-top:0px;">
		  			...
		  			<tr>
						...
						<td style="display:none" width="70px" align="center">品番</td>
		  			...
		  			<tbody id="ctbody">
					<s:iterator value="NextdeliveryInfo">
						<tr  align="center">
	...
	<div id="floatPanel" >
	  		<div class="ctrolPanel" style="right:10px;">
				...
				<a class="contact" >
				<input type="button" value="変更納期" style="height:50px;width:80px" onclick="naqiChange(2)"/>
				</a>
				<a class="contact" >
				<input type="button" value="納品完了" style="height:50px;width:80px" onclick="napinFinsh(2)"/>
				</a>
				<a class="contact"   >
